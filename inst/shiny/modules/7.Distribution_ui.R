tabItem(
  ...
  fluidRow(
    box(
      ...
      sliderInput("distribution_title_text_size", "Title Text Size:", min = 0, max = 30, value = 13, step = 1, width = "100%"),
      sliderInput("distribution_label_text_size", "Label Text Size:", min = 0, max = 30, value = 12, step = 1, width = "100%"),
    ...
    box(
      ...
      div(
        ...
        dropdown(
          ...
          sliderInput("Distribution_download_width", "Download Plot width", min = 0, max = 15, value = 7, step = 0.5, width = "100%"),
