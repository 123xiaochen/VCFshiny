--- 
title: "VCFShiny Description Document"
...
description: "VCFshiny software Usage Instructions"
link-citations: yes
...
### How to install and run VCFshiny

1. Open *R*.
2. Install and run VCFshiny by the following commands in R:
